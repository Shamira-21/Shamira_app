function Home() {
  ...
  return (
    <div className="relative overflow-hidden min-h-[550px] sm:min-h-[650px] flex flex-col items-center ">
      ...
      <section id="about" className="py-20 mt-10 my-5 bg-gray-800 text-white w-full">
              <div className="container mx-auto text-center">
                 <h2 className="text-3xl font-bold mb-4">About Me</h2>
                 <p className="text-lg">
                 I am a passionate developer with a keen interest in creating dynamic and interactive web applications.
                 </p>
              </div>
      </section>
